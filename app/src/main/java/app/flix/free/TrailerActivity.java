...
public class TrailerActivity extends  AppCompatActivity  { 
	...
	private void initializeLogic() {
		id = getIntent().getStringExtra("embed").replace("https://www.youtube.com/embed/", "");
		getLifecycle().addObserver(youtube1);
		
		
		youtube1.addYouTubePlayerListener(new com.pierfrancescosoffritti.androidyoutubeplayer.core.player.listeners.AbstractYouTubePlayerListener() {
			  @Override
