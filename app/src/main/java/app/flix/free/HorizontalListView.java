...
public class HorizontalListView extends AdapterView<ListAdapter> {
     ...
     *
     * disallowIntercept If true the parent will be prevented from intercepting child touch events
     */
   public void requestParentListViewToNotInterceptTouchEvents(Boolean bool) {
   	View view = (View)getParent();
        if (mIsParentVerticiallyScrollableViewDisallowingInterceptTouchEvent != bool.booleanValue()) {
            if ((view instanceof ListView) || (view instanceof ScrollView)) {
                ((ScrollView) view).requestDisallowInterceptTouchEvent(bool.booleanValue());
                mIsParentVerticiallyScrollableViewDisallowingInterceptTouchEvent = bool.booleanValue();
            }
    ...
    private void addAndMeasureChild(final View child, int viewPos) {
        ...
        measureChild(child);
		//setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,getLayoutParams(child).width));
    }
