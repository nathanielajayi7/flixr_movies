...
public class TourVideoPlayer extends FrameLayout implements IVideoPlayer,
    ...
    public void restart() {
        //先判断网络状态
        mCurrentNetworkState = NetworkChangeReceiver.getNetworkStatus(app.flix.free.SketchApplication.getInstance());
    ...
    public void enterFullScreen() {
        ...
        TourVideoUtil.scanForAppCompatActivity(mContext)
                .setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
/*
        new Handler().post(new Runnable() {
            @Override
            public void run() {
                ViewGroup contentView = (ViewGroup) TourVideoUtil.scanForAppCompatActivity(mContext)
