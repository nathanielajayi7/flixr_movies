...
public class TourVideoUtil {
    ...
    public static AppCompatActivity scanForAppCompatActivity(Context context) {
        if (context == null) return null;
        if (context instanceof AppCompatActivity) {
            return (AppCompatActivity) context;
        } else if (context instanceof ContextWrapper) {
            return scanForAppCompatActivity(((ContextWrapper) context).getBaseContext());
        }
        return null;
    }

    public static void showActionBar(Context context) {
//        ActionBar ab = getAppCompAppCompatActivity(context).getSupportActionBar();
//        if (ab != null) {
//            ab.setShowHideAnimationEnabled(false);
//            ab.show();
//        }
        scanForAppCompatActivity(context)
                .getWindow()
